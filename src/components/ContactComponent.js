...
class Contact extends Component {
    ...
    handleSubmit(values) {
        ...
        alert("feedback state at commit: ", this.props.feedback)
        alert("rrf form: ", this.props.forms)
        console.log('Current State is: ' + JSON.stringify(values));
        alert("name: " + values.firstname + " " + values.lastname + " telnum " + values.telnum + " email " + values.email + " feedback " + values.message);
        
        //setTimeout(() => this.props.resetFeedbackForm(), 100);
