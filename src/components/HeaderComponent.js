...
class Header extends Component{
    ...
    toggleModal() {
        console.log("toggle modal login clicked");
    ...
    render(){
        ...
        //                     <div className="col-12 col-sm-6">
        //                         <h1>Ristorante Con Fusion</h1>
        //                         <p>We take inspiration from the World's best cuisines, and create a unique fusion experiance. Our lipsmacking creations will tickle your culinary senses!</p>
        //                     </div>
        //                 </div>
        //             </div>
        //         </Jumbotron>
